        ...
        <div className="flex max-w-screen-xl mx-auto w-full">
          <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
            <a href="javascript:void(0)" className="max-sm:hidden">
              <img
                src="src/assets/craftkokoLogo.png"
                alt="logo"
                className="w-20 flex relative" // Adjust the value accordingly
              />
            </a>
              ...
              <ul className="lg:flex lg:gap-x-3 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                <li className="mb-6 hidden max-lg:block">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button className="px-4 py-2 text-sm rounded-full text-white border-2 bg-[#F33A6A] hover:bg-[#F33A6A]">
                      Sign In
                    </button>
                  </div>
                </li>
                <li className="max-lg:border-b max-lg:py-3 px-3">
                  <a
                    ...
                    className="text-[#333]  hover:text-[#F33A6A] text-[15px] block font-semibold"
                  >
                    Chocolate
                  </a>
                </li>
            ...
            <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
              ...
              <div className="flex items-center sm:space-x-8 space-x-6">
                ...
                <button className="max-lg:hidden px-4 py-2 text-sm rounded-full text-white border-2 border-[#F33A6A] bg-[#F33A6A] hover:bg-[#f33a6bcf]">
                  Sign In
                </button>
